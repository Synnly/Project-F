 ...
 * de probaBloc - DECROISSANCE_CONTAGION de devenir un obstacle et de propager à leur tour leur obstacle aux 8 blocs autour d'eux. Met à jour les faces des blocs
...
/**
 * Remet tous les blocs de la liste à l'état non obstacle
 * @param liste La liste
 */
