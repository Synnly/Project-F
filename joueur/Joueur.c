...
void initJoueur(Joueur* joueur){
    joueur->sprite = malloc(sizeof(Sprite));
    initSprite(joueur->sprite, (WINDOW_WIDTH/2)-(JOUEUR_WIDTH/2), (WINDOW_HEIGHT/2)-(JOUEUR_HEIGHT/2), JOUEUR_WIDTH, JOUEUR_HEIGHT, NULL);
